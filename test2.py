...
def start_message(message):
    bot.send_message(message.chat.id, 'Здравствуйте! \nВыберите интересующую Вас позицию\U0001F4CB', reply_markup=keyboard1)

@bot.message_handler(content_types=['text'])
def handle_text(message):

      if message.text == "Цена\U0001F4B5":
          bot.send_message(message.chat.id, '\U0001F4DDСоздание бота - от 40000тг(8000р)\n\U0001F9D4Администрирование - от 10000 тг/мес(2000р/мес)')
